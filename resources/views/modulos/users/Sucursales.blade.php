    ...
    <div class="content-wrapper">
        ...
        <div class="modal fade" id="modalAgregarSucursal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ url('Agregar-Sucursal') }}" method="post">
                        @csrf
        ...
        <section class="content">
            <div class="box">
                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped table-hover dt-responsive" id="miTabla">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Sucursal</th>
                            ...
                            @foreach ($sucursales as $sucursal)
                                @if($sucursal->estado == 1)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-warning btn-sm btnEditarSucursal" data-toggle="modal" data-target="#modalEditarSucursal" idSucursal="{{ $sucursal->id }}">
